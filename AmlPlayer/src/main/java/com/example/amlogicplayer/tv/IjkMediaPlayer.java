...
package com.example.amlogicplayer.tv;
...
import com.example.amlogicplayer.tv.annotations.AccessedByNative;
import com.example.amlogicplayer.tv.annotations.CalledByNative;
import com.example.amlogicplayer.tv.misc.IAndroidIO;
import com.example.amlogicplayer.tv.misc.IMediaDataSource;
import com.example.amlogicplayer.tv.misc.ITrackInfo;
import com.example.amlogicplayer.tv.misc.IjkTrackInfo;
import com.example.amlogicplayer.tv.pragma.DebugLog;
...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    private void initPlayer(IjkLibLoader libLoader) {
        ...
        //native_setLogLevel(IJK_LOG_VERBOSE);
        this.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "mediacodec-all-videos", 1);
        this.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "max-buffer-size", 8*1024*1024);
        this.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "min-frames", 300);
        this.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "max-fps", 100);
        this.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "framedrop", 10);
        this.setOption(IjkMediaPlayer.OPT_CATEGORY_FORMAT, "live_start_index", -4);
    }
